...
- `about-me.md` — **§13** の自己紹介（ダミー。**差し替え**演習用）
- `meeting-memo.txt` — **§14** の議事メモ（ダミー）
- `.claude/skills/meeting-summary/SKILL.md` — **§10**・**§14** の Skill 例
...
> [!NOTE]
> **ルールの追記実習**は **§15** で行います（ゼロから作るのではなく、既存の `CLAUDE.md` に 1 行足す）。
...
├── README.md                  # サンプルの説明
├── CLAUDE.md                  # 共有ルール
├── about-me.md                # §13 用（差し替え演習）
├── meeting-memo.txt           # §14 用のダミー議事メモ
├── examples/                  # 参考解答
│   ├── README.md
│   ├── about-me.md
│   └── meeting-summary.md
