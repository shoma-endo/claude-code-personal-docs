...
エディターで `~/claude-code-personal` を開いても構いません。**Session 1 は §4 以降、同じ作業フォルダで進めます。**
...
> [!IMPORTANT]
> **講義用サンプルデータは Session 1 の §4 以降ずっと同じフォルダで使います。** エディターで `CLAUDE.md` や Skill ファイルを**実際に開きながら**学び、§17 以降ではファイル操作の演習に入ります。
...
> [!IMPORTANT]
> Session 2 では **cc-secretary（AI 秘書）を Lark CLI より先に** 完了してください。
