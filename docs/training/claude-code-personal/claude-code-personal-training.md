...
- `about-me.md` — **§12** の自己紹介（ダミー。**差し替え**演習用）
- `meeting-memo.txt` — **§13** の議事メモ（ダミー）
- `.claude/skills/meeting-summary/SKILL.md` — **§10**・**§13** の Skill 例
...
> [!NOTE]
> **ルールの追記実習**は **§14** で行います（ゼロから作るのではなく、既存の `CLAUDE.md` に 1 行足す）。
...
├── README.md                  # サンプルの説明
├── CLAUDE.md                  # 共有ルール
├── about-me.md                # §12 用（差し替え演習）
├── meeting-memo.txt           # §13 用のダミー議事メモ
├── examples/                  # 参考解答
│   ├── README.md
│   ├── about-me.md
│   └── meeting-summary.md
