...
| セッション | 時間 | 備考 |
|---|---|---|
| Session 1 | **2 時間** | 質疑応答 15 分を含む |
| Session 2 | 別枠 | 本資料の Session 2 進行表を参照 |
...
| **前半** | §1〜§9 | 概要、CLI 前提、安全、起動・対話・許可、エージェントループ |
| **前半** | §10〜§15 | `CLAUDE.md`・`.claude/skills` 等の実物で設定の説明 |
| **後半** | §16〜§19 | ファイル作成・要約・`CLAUDE.md` 追記 |
| **締め** | §20 | 振り返り（コマンド一覧は資料参照） |
...
| 4 | サンプルフォルダで起動、初回対話、許可・停止 | 実習 | 18分 | §4〜7 |
| 5 | チェックポイント、エージェントループ | 講義 | 8分 | §8〜9 |
| 6 | `CLAUDE.md`・`.claude/`・Skills を実物で確認（Plan・コンテキストは要点のみ） | 講義・対話 | 22分 | §10〜15 |
| 7 | `about-me.md` 作成 | 実習 | 12分 | §17 |
| 8 | 議事メモ要約、`CLAUDE.md` 追記 | 実習 | 20分 | §18〜19 |
| 9 | 振り返り（§20 は資料参照） | 講義 | 5分 | §20 |
| 10 | **質疑応答** | 対話 | 15分 | — |
| | **合計** | | **130分** | バッファ約10分 |

---

## Session 2 進め方（インストール順）

Session 2 では **cc-secretary を Lark CLI より先に必ず完了** してください。
